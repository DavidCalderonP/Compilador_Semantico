...
/* Generated By:JavaCC: Do not edit this line. AdminToken.java */
import java.io.*;

/** Token Manager. */
public class AdminToken implements CompiladorCon
{
	...
	/** Constructor. */
	public AdminToken(SimpleCharStream stream){
	...
	/** Constructor. */
	public AdminToken(SimpleCharStream stream, int lexState){
		this(stream);
		SwitchTo(lexState);
	}
