...
/* Generated By:JavaCC: Do not edit this line. AppCompilador.java */
import java.io.*;
import java.util.ArrayList;
import java.util.Hashtable;


class AppCompilador implements CompiladorCon {
	...
	public static void main( String[] args )throws ParseException, Exception
	{
		try
		{
			AppCompilador analizador = new AppCompilador(new FileInputStream("src/CompiladorSematicoFinal/code.txt"));
			analizador.Programa();
			System.out.println();
			System.out.println();
			AsignaToken.TablaSimbolos();
	...
	static final public void VariablesLocales() throws ParseException {
		...
		AsignaToken.InsertarSimbolo(var, td);
	...
	static final public void VariablesAsignacion(Token v1, int Tipo) throws ParseException {
		...
		TiposAsignaciones();
		v2 = token;
		res = AsignaToken.checkAsing(v1, v2, Tipo);
		...
		label_3:
			while (true) {
				...
				TiposAsignaciones();
				v3 = token;
				res = AsignaToken.checkAsing(v1, v3,tipo );
	...
	static final public void SentenciaAsignacion() throws ParseException {
		...
		case DECR:
			...
			res = AsignaToken.checkVariable(v1);
	...
	static public AdminToken token_source;
	...
	public AppCompilador(java.io.InputStream stream) {
		this(stream, null);
	}
	/** Constructor with InputStream and supplied encoding */
	public AppCompilador(java.io.InputStream stream, String encoding) {
		...
		token_source = new AdminToken(jj_input_stream);
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
	...
	/** Constructor. */
	public AppCompilador(java.io.Reader stream) {
		if (jj_initialized_once) {
			System.out.println("ERROR: Second call to constructor of static parser. ");
			System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
			System.out.println("       during parser generation.");
	...
	public AppCompilador(AdminToken tm) {
		if (jj_initialized_once) {
			System.out.println("ERROR: Second call to constructor of static parser. ");
			System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
			System.out.println("       during parser generation.");
	...
	/** Reinitialise. */
	public void ReInit(AdminToken tm) {
		token_source = tm;
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
