...
class AsignaToken
{
	  //public static TablaDeSimbolos Datos[] =  new TablaDeSimbolos[100]; 
	  ...
	  //static ArrayList<TablaDeSimbolos> Datos = new ArrayList<TablaDeSimbolos>();
	...
	public static void InsertarSimbolo(Token identificador, int tipo)
	{
		...
		//Datos.add(new TablaDeSimbolos(L, TipoValor, "null",Linea));
